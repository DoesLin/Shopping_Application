...
public class UtilisateurControlleur {
	...
	public UtilisateurControlleur(VenteControlleur venteControlleur) {
	...
	void initialize() {
		assert texteCate != null : "fx:id=\"texteCate\" was not injected: check your FXML file 'Utilisateur.fxml'.";
		assert affiche != null : "fx:id=\"affiche\" was not injected: check your FXML file 'Utilisateur.fxml'.";
		assert categorie != null : "fx:id=\"categorie\" was not injected: check your FXML file 'Utilisateur.fxml'.";
		...
		assert gererAnnonce != null : "fx:id=\"gererAnnonce\" was not injected: check your FXML file 'Utilisateur.fxml'.";
		assert gererAcceptation != null : "fx:id=\"gererAcceptation\" was not injected: check your FXML file 'Utilisateur.fxml'.";
