...
/**
 * Classe permettant la gestion des offres proposes sur le site internet.
 * @author Moutas Ribeiro et Lin 
 *
 */
public class GestionOffreControlleur {
	...
	public GestionOffreControlleur(VenteControlleur venteControlleur) {
